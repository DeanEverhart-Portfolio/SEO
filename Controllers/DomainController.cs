...
namespace SEO.Controllers
{
    ...
    public class DomainController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Domain.Include(d => d.Clients);
        ...
        {
            ViewData["ClientId"] = new SelectList(_context.Client, "Id", "ClientDesignator");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Type,ClientId")] Domain domain)
        {
            ...
            ViewData["ClientId"] = new SelectList(_context.Client, "Id", "ClientDesignator", domain.ClientId);
            return View(domain);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Type,ClientId")] Domain domain)
        {
            if (id != domain.Id)
            {
                return NotFound();
