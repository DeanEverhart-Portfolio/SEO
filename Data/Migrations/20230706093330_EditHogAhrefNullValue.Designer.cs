...
namespace SEO.Data.Migrations
{
    ...
    [Migration("20230706093330_EditHogAhrefNullValue")]
    partial class EditHogAhrefNullValue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEO.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ClientDesignator")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SEO.Models.zz_Hog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClientContact", b =>
                {
                    b.HasOne("SEO.Models.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SEO.Models.Contact", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SEO.Models.ContactClient", b =>
                {
                    b.HasOne("SEO.Models.Client", "Clients")
